...
class CustomButton extends StatelessWidget {
  ...
  CustomButton({required this.onPressed, required this.buttonText, this.transparent = false, this.margin, this.width, this.height,
    this.fontSize, this.radius = 5, this.icon,this.isgreen=false});

  @override
  Widget build(BuildContext context) {
    final ButtonStyle _flatButtonStyle = TextButton.styleFrom(
      backgroundColor: onPressed == null ? Theme.of(context).accentColor : transparent
          ? Colors.transparent :isgreen?Theme.of(context).accentColor:Theme.of(context).primaryColor,
