        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
              ...
              borderSide: BorderSide(style: BorderStyle.solid, width: 0.3,color: Colors.black12),
            ),
            isDense: true,
            ...
            prefixIcon: widget.prefixIcon != null ? Padding(
              ...
              child: Image.asset(widget.prefixIcon!, height: 20, width: 20,color: Theme.of(context).accentColor,),
            ) : null,
          ...
          onChanged:(test)=> widget.onChanged,
        ),
